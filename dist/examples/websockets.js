...
function App() {
    ...
    return (_jsxs("yjoin", { widthAlign: "start", heightAlign: "middle", fg: 5, invert: true, gap: 'space-between', children: [_jsxs("para", { doubleWidth: true, doubleHeight: true, children: ["Running for ", stuff, " secs"] }), _jsx("para", { children: App.toString() })] }));
}
;
